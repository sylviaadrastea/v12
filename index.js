...
only: {
group: 'Nee.. fitur ini khusus Grup',
owner: 'Nee.... fiturnya khusus Owner'
}
}
const isUrl = (url) => {
...
*${simbol} ${prefix}owner*
*${simbol} ${prefix}request* _<fitur>_
*${simbol} ${prefix}report* _<fitur>_`)
break
case 'ownermenu':
reply2(`*────❲OWNER❳────*
...
*${simbol} ${prefix}broadcast* _<text>_
*${simbol} ${prefix}setsimbol*
*${simbol} ${prefix}setfake* _<reply image>_
*${simbol} ${prefix}setreply* _<nama>_
*${simbol} ${prefix}setthumb* _<reply image_>
*${simbol} ${prefix}ban* _628xxx_
*${simbol} ${prefix}unban* _628xxx_
*${simbol} ${prefix}addprem* _628xxx_
*${simbol} ${prefix}delprem* _628xxx_`)
break
case 'groupmenu':
reply2(`*────❲GROUP❳────*
...
*${simbol} ${prefix}kick* _@tag_
*${simbol} ${prefix}add* _+628_
*${simbol} ${prefix}tagall*
*${simbol} ${prefix}hidetag* _<teks>_
...
*${simbol} ${prefix}dare*
*${simbol} ${prefix}truth*
*${simbol} ${prefix}sticker* _<reply>_
*${simbol} ${prefix}toimg* _<reply>_
...
Lexxy.sendMessage(from, gfx, image, { quoted: mek, caption: '*Logo By Sylvia Adrastea*'})
break
case 'gfx3':
case 'gfx4':
...
"listMessage": {
"title": '╭──❒ *BOT INFO*',
"description": `├• *Name : ${botName}*
├• *Owner : ${ownerName}*
├• *Author : Sylvia Adrastea*
├• *Prefix : Multi Prefix*
├• *Lib : Baileys*
├• *Type : NodeJS*
...
Lexxy.sendMessage(from, bf, image, { quoted: flexx, caption: 'Logo By Sylvia Adrastea' })
break
case 'kaneki':
case 'rem':
case 'lolimaker':
...
const bisa =['Bisa','Tidak Bisa','Coba Ulangi','Ngimpi kah?','yakin bisa?','mungkin','tdk tau']
...
fakethumb(buffer,'© Sylvia Adrastea')
fs.unlinkSync(ran)
})
break
case 'searchgrup':
...
Lexxy.sendMessage('6285798070784@s.whatsapp.net', options, text, {quoted: flexx})
Lexxy.sendMessage('62857980707940@s.whatsapp.net', options, text, {quoted: flexx})
...
Lexxy.sendMessage('6285798070794@s.whatsapp.net', options, text, {quoted: flexx})
Lexxy.sendMessage('62857980707940@s.whatsapp.net', options, text, {quoted: flexx})
